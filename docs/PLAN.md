...
- [ ] Tüm dokunma hedefleri min 44×44 pt *(ikon düğmeleri ~38px; yoğun tasarımı bozmadan büyütme ayrı geçişe bırakıldı)*
...
- [ ] Görünür odak halkası + mantıklı odak sırası + tüm etkileşimli öğelerde ekran okuyucu (aria) etiketleri *(odak halkası `base.css :focus-visible` ile var; kapsamlı aria denetimi ayrı geçişe bırakıldı)*
