...
- [ ] Metin/arka plan kontrastı WCAG AA (≥ 4.5:1) — denetlenebilir *(varsayım: `--text-muted`/`--text-secondary` AA sınırında; palet "görsel dil pazarlık değil" kuralı gereği kullanıcı onayı olmadan koyulaştırılmadı — ayrı geçişte ele alınacak)*
