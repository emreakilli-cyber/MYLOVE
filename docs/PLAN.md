...
- [ ] Tüm dokunma hedefleri min 44×44 pt *(varsayım: ikon düğmeleri ~38px — WCAG 2.5.8 AA asgarisini (24px) zaten aşıyor; 44px [Apple HIG / WCAG AAA 2.5.5] referans yoğunluğunu değiştireceğinden ve "görsel dil pazarlık değil" kuralı gereği kullanıcı kararına bırakıldı)*
